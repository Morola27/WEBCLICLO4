...
export class CreateComponent implements OnInit {
  ...
  fgValidacion = this.fb.group({
    ...
    tiempo_estimado: ['', [Validators.required, Validators.minLength(1)]],
  ...
  store(){
    ...
    ruta.origen = this.fgValidacion.controls["tiempo_estimado"].value as string;
    ruta.destino = this.fgValidacion.controls["tiempo_estimado"].value as string;
